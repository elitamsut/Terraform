...
# Ensure the variable is assigned a value (either in terraform.tfvars or passed as an input)
# variables.tf
variable "gke_num_nodes" {
  description = "Number of nodes in the GKE cluster"
  type        = number
  default     = 2  # Set a default value, or omit it if you want to specify it later
}
